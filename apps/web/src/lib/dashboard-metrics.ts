...
export const METRIC_CATALOG: MetricDef[] = [
  ...
  { key: "minhas_tarefas_atrasadas", label: "Minhas tarefas atrasadas", category: "Tarefas", tone: "text-red-400", href: "/tarefas?visao=minhas&prazo=atrasadas", permission: "tasks.view", personal: true, alert: true },
